<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage, filter, and search all categories on the platform.</p>
            </div>
    ...
    {{-- Toast Notification (more modern than an alert box) --}}
    @if (session('success'))
                                            ...
                                            <div x-data="{ open: false, deleting: false }">
                                                ...
                                                <div x-show="open" @click.away="open = false"
                                                    ...
                                                    <button @click="deleting = true; open = false"
                                                        class="block w-full text-left px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-800">Delete</button>
                                                </div>
                                                    ...
                                                    <div @click.away="deleting = false"
                                                        ...
                                                        <p
                                                            ...
                                                            Are you sure you want to delete the category <span
                                                                class="font-semibold">"{{ $item->name }}"</span>? This
                                    ...
                                    <tr>
                                        <td colspan="4" class="px-6 py-12 text-center">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="mt-4 text-sm font-semibold text-gray-700 dark:text-gray-200">No
                                                    Category Data</p>
                                                <p class="text-sm text-gray-500">Start by adding a new category.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
