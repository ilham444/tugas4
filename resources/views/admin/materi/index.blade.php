<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row items-center justify-between">
            ...
            <a href="{{ route('admin.materi.create') }}" class="mt-4 md:mt-0 inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition-colors">
                                    ...
                                    <tr>
                                        <td colspan="4" class="px-6 py-12 text-center">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="mt-4 text-sm font-semibold text-gray-700 dark:text-gray-200">Tidak Ada Data Materi</p>
                                                <p class="text-sm text-gray-500">Mulai dengan menambahkan materi baru.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
