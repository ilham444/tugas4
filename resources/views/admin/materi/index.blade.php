                        ...
                        <div class="w-full md:w-1/2 lg:w-1/3">
                            <div class="relative">
                                ...
                                <input type="text" name="search" id="search"
                                    class="block w-full pl-10 pr-3 py-2 border rounded-lg bg-white dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 placeholder-gray-500 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                            ...
                                            <div x-data="{ open: false, deleting: false }">
                                                ...
                                                <div x-show="deleting" x-cloak x-transition
                                                    ...
                                                    <div @click.away="deleting = false"
                                                        ...
                                                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">Anda yakin
                                                            ingin menghapus materi <span
                                                                class="font-semibold">"{{ $item->title }}"</span>?</p>
