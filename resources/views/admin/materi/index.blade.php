<x-app-layout>
    ...
    @if (session('success'))
        ...
        <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 5000)" x-show="show" class="fixed top-24 right-5 bg-green-500 text-white py-2 px-4 rounded-xl text-sm shadow-lg z-50">
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
                        <div class="w-full md:w-1/2 lg:w-1/3">
                            <div class="relative">
                                ...
                                <input type="text" name="search" id="search" class="block w-full pl-10 pr-3 py-2 border rounded-lg bg-white dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 placeholder-gray-500 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Cari berdasarkan judul...">
                            </div>
                        </div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div x-data="{ open: false, deleting: false }" class="relative">
                                                ...
                                                <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-900 rounded-md shadow-lg py-1 ring-1 ring-black ring-opacity-5 z-10">
                                                    <a href="{{ route('admin.materi.edit', $item->id) }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800">Edit</a>
                                                ...
                                                <div x-show="deleting" x-cloak x-transition class="fixed inset-0 z-40 flex items-center justify-center bg-black bg-opacity-50">
                                                    <div @click.away="deleting = false" class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 max-w-md w-full">
                                                        ...
                                                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">Anda yakin ingin menghapus materi <span class="font-semibold">"{{ $item->title }}"</span>?</p>
