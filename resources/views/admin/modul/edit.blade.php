        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    Edit Module: <span class="text-indigo-500">{{ Str::limit($modul->title, 30) }}</span>
                </h2>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Make changes to the module details below.</p>
            </div>
                ...
                <div x-show="open" :class="{'flex': open, 'hidden': !open}" x-cloak
                    ...
                    <div @click.away="open = false"
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">Are you sure you want to permanently delete
                            the module <span class="font-semibold">"{{ $modul->title }}"</span>? This action cannot
                            be undone.
                        </p>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        <div
                            ...
                            <div class="mt-4">
                                <label for="estimated"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Estimated Time
                                    (minutes)</label>
                        ...
                        <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700"
                            ...
                            {{-- Drag & Drop Area (Shows when 'Change File' is clicked) --}}
                            <div x-show="showUploader" x-cloak>
                                <label x-data="fileDrop()"
                                    ...
                                    <div x-show="!fileName" class="z-10">
                                        <p class="text-sm text-gray-600 dark:text-gray-300">Drag a new file here</p>
                                    </div>
                                    <div x-show="fileName"
