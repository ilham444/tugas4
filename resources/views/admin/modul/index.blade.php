    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Kelola, filter, dan cari semua modul di
                    platform.</p>
            </div>
                                        ...
                                        <td colspan="6" class="px-6 py-12 text-center">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="mt-4 text-sm font-semibold text-gray-700 dark:text-gray-200">Tidak
                                                    Ada Data Modul</p>
                                                <p class="text-sm text-gray-500">Mulai dengan menambahkan modul baru.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
