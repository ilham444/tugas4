        ...
        <main class="py-10">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <h3 class="font-bold text-lg">Uji Pengetahuan Anda</h3>
                    <p>Klik tombol di bawah ini untuk memulai quiz.</p>
                    <a href="{{ route('quiz.start') }}" class="inline-block mt-4 px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700">
                        Mulai Quiz Sekarang!
                    </a>
                                        </div>
                                </div>
